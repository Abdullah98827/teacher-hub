        ...
        <View className="bg-neutral-900 rounded-t-3xl p-6 max-h-[80%]">
          <View className="flex-row items-center justify-between mb-4">
            <View className="flex-1">
              <Text className="text-white text-2xl font-bold">Subscribers</Text>
              <Text className="text-gray-400 text-sm">{subjectName}</Text>
            </View>
          ...
          {loading ? (
            ...
            <View className="items-center justify-center py-10">
              ...
              <Text className="text-gray-400 mt-4">No subscribers yet</Text>
            </View>
          ) : (
            <FlatList
              data={subscribers}
              ...
              renderItem={({ item }) => (
                <View className="bg-neutral-800 rounded-lg p-4 mb-2 flex-row items-center">
