...
type TabId = "simplified" | "vocabulary" | "tips" | "glossary";
...
export default function EALAdapterModal({
  visible,
  onClose,
  resourceId,
}: Props) {
  ...
  const [result, setResult] = useState<EALResult | null>(null);
  const [activeTab, setActiveTab] = useState<TabId>("simplified");
