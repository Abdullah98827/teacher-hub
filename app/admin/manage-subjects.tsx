          ...
          <ScrollView className={`${bgCard} rounded-t-3xl p-6 max-h-[90%]`}>
            ...
            <TouchableOpacity
              className={`py-4 rounded-full mt-2 ${
                formData.name.trim() ? "bg-cyan-500" : "bg-neutral-800"
              }`}
...
//   const [isSubjectPublic, setIsSubjectPublic] = useState(false);
//   const [isGroupChatPublic, setIsGroupChatPublic] = useState(false);
//   const [saving, setSaving] = useState(false);
...
//           // REPLACE the subscriber count logic in fetchSubjects with this:
//           let subscriberCount = 0;

//           if (subject.is_public) {
//             // For public subjects, count ALL active teachers
//             const { count } = await supabase
//               .from("teachers")
//               .select("*", { count: "exact", head: true })
//               .eq("verified", true)
...
//             subscriberCount = count || 0;
//           } else {
//             // For private subjects, count only subscribed teachers
//             const { count } = await supabase
//               .from("memberships")
//               .select("*", { count: "exact", head: true })
...
//     setIsSubjectPublic(false);
//     setIsGroupChatPublic(false);
//     setShowModal(true);
//   };
...
//     setGroupChatDescription(subject.groupChat?.description || "");
//     setIsSubjectPublic(subject.is_public);
//     setIsGroupChatPublic(subject.groupChat?.is_public || false);
//     setShowModal(true);
//     setMenuOpenId(null);
//   };
...
//             .from("group_chats")
//             .update({
//               name: `${subjectName.trim()} Teachers Chat`,
//               description:
//                 groupChatDescription.trim() ||
//                 `Group chat for all ${subjectName.trim()} teachers`,
//               is_public: isGroupChatPublic,
//             })
//             .eq("id", editingSubject.groupChat.id);
...
//   const renderSubject = ({ item }: { item: SubjectWithGroupChat }) => {
...
//                     onPress={() => {
//                       setMenuOpenId(null);
//                       router.push(`/group-chat/${item.groupChat!.id}`);
//                     }}
//                   >
//                     <Ionicons name="chatbubbles" size={18} color="#22d3ee" />
//                     <Text className="text-white ml-3">View Chat</Text>
//                   </TouchableOpacity>
//                 )}
...
//               {item.is_public ? "can access" : "subscribers"}
//             </Text>
//           </View>
...
//   const totalSubscribers = subjects.reduce(
//     (sum, s) => sum + s.subscriberCount,
//     0
//   );
//   const totalMessages = subjects.reduce((sum, s) => sum + s.messageCount, 0);
//   const totalDeleted = subjects.reduce(
...
//                 onChangeText={setGroupChatDescription}
//                 multiline
//                 numberOfLines={2}
//               />
//               <Text className="text-gray-600 text-xs mt-1">
//                 Group chat name will be "{subjectName || "Subject"} Teachers
//                 Chat"
//               </Text>
//             </View>

//             {/* SUBJECT Access Toggle */}
//             <View className="mb-4">
...
//                 }`}
//                 onPress={() => setIsSubjectPublic(!isSubjectPublic)}
//               >
//                 <View className="flex-row items-center justify-between">
//                   <View className="flex-row items-center flex-1">
//                     <View
//                       className={`w-12 h-12 rounded-full items-center justify-center mr-3 ${
//                         isSubjectPublic ? "bg-green-500/20" : "bg-purple-500/20"
//                       }`}
//                     >
//                       <Ionicons
//                         name={isSubjectPublic ? "globe" : "lock-closed"}
//                         size={24}
//                         color={isSubjectPublic ? "#22c55e" : "#a855f7"}
//                       />
//                     </View>
//                     <View className="flex-1">
//                       <Text
//                         className={`font-bold text-lg ${
//                           isSubjectPublic ? "text-green-400" : "text-purple-400"
//                         }`}
//                       >
//                         {isSubjectPublic
//                           ? "Public Resources"
...
//                         {isSubjectPublic
//                           ? "All teachers can see resources"
//                           : "Only subscribers can see resources"}
//                       </Text>
//                     </View>
//                   </View>
//                   <View
...
//                     : "bg-purple-500/10 border-purple-500"
//                 }`}
//                 onPress={() => setIsGroupChatPublic(!isGroupChatPublic)}
//               >
//                 <View className="flex-row items-center justify-between">
//                   <View className="flex-row items-center flex-1">
//                     <View
...
//                     >
//                       <Ionicons
//                         name={isGroupChatPublic ? "chatbubbles" : "lock-closed"}
//                         size={24}
//                         color={isGroupChatPublic ? "#22c55e" : "#a855f7"}
//                       />
//                     </View>
//                     <View className="flex-1">
//                       <Text
...
//                       <Text className="text-gray-500 text-xs">
//                         {isGroupChatPublic
//                           ? "All teachers can join chat"
//                           : "Only subscribers can join chat"}
//                       </Text>
//                     </View>
//                   </View>
//                   <View
...
//                 subjectName.trim() ? "bg-cyan-500" : "bg-neutral-800"
//               }`}
//               onPress={handleSaveSubject}
